...
public class MessageBufferTest {
    ...
    public void testGetMessage() {
        ...
        Message message3 = messageBuffer.getMessage();

        assertNotNull(message3);
        assertEquals(8192    , message3.offset);
        assertEquals(0       , message3.length);
        assertEquals(4 * 1024, message3.capacity);
    ...
    public void testExpandMessage(){
        ...
        //将一个只有4KB的message扩展成128KB的message
